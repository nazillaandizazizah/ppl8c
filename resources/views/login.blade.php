...
<!-- BUTTON MASUK -->
								<a href="http://localhost:8000/peternak/home"><button id="login-btn" type="submit"> Masuk </button></a>

<!-- BUAT AKUN -->
								<p class="login-subfooter">
									Belum menjadi member Tersekuy? Silahkan
									<a
									href="http://localhost:8000/daftar">
									Buat Akun
								</a> terlebih dahulu.
							</p>
						</form>
...
<!-- LUPA PASSWORD -->
				<p class="login-footer" style="text-align: right; padding-right: 7%;">
					Tidak dapat masuk?
					<a href="http://localhost:8000/lupapassword">
					Lupa kata sandi?
				</a>
			</p>
		</div>
