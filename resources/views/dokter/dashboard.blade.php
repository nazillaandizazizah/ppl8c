...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! asset('/css/dokter.css') !!}">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                ...
                                <li><a href="http://localhost:8000/dokter/home"><img src="https://funkyimg.com/i/2XQQF.png" style="width: 32px;"> Home</a>
                                </li>

                                <li><a href="http://localhost:8000/dokter/konsultasi"><img src="https://funkyimg.com/i/2XQQG.png" style="width: 32px;"> Konsultasi</a></li>

                                <li><a href="http://localhost:8000/dokter/riwayat"><img src="https://funkyimg.com/i/2XS4T.png" style="width: 32px;"> Riwayat</a></li>

                                <li><a href="http://localhost:8000/dokter/artikel"><img src="https://funkyimg.com/i/2XS4S.png" style="width: 35px;"> Artikel</a></li>

                                <li><a href="http://localhost:8000/dokter/profil"><img src="https://funkyimg.com/i/2XQQE.png" style="width: 35px;"> Profil</a></li>
                ...
                <div class="nav_menu">
                    <nav>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="http://localhost:8000/dokter/login" class="user-profile dropdown-toggle" >
